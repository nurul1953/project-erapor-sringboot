    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <c:url var="insert" value="/insertSiswa">
                        </c:url>
                        <a href="${insert}">Tambah Data Siswa</a>
                    </div>
                </div>
                <div class="card mb-4">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach var="sw" items="${siswa}">
                                <tr>
                                    ...
                                    <td>${sw.alamat_ayah}</td>
                                    <td>${sw.alamat_ibu}</td>
                                    <td>${sw.nama_wali}</td>
                                    <td>${sw.pekerjaan_wali}</td>
                                    <td>${sw.alamat_wali}</td>
                                    <td>
                                        <c:url var="updateSiswa" value="/updateSiswa">
                                            <c:param name="nis" value="${sw.nis}"/>
                                        </c:url>
                                        <a href="${updateSiswa}">Edit</a>
                                        <c:url var="deleteSiswa" value="/deleteSiswa">
                                            <c:param name="nis" value="${sw.nis}"/>
                                        </c:url>
                                        <a href="${deleteSiswa}">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
