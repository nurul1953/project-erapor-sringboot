    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <c:forEach var="sklh" items="${Sekolah}">
                <div class="card mb-4">
                    <div class="card-body">
                        <c:url var="updateSekolah" value="/updateSekolah">
                            <c:param name="npsn" value="${sklh.npsn}"/>
                        </c:url>
                        <a href="${updateSekolah}">Update Data Sekolah</a>
                    </div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table style="padding: 50px" cellspacing="50px">
                            <tr>
                                <img src="/images/${sklh.foto}" style="height: 160px; width: 200px">
                            </tr>
                            <tr>
                                    <td>Nama Sekolah</td>
                                    <td>:</td>
