    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <c:url var="insert" value="/insertNilai">
                    </c:url>
                    <a href="${insert}">Tambah Data Nilai</a>
                </div>
                <div class="card mb-4">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <c:forEach var="nilai" items="${Nilai}">
                                <tr>
                                    ...
                                    <td>${nilai.nilai}</td>
                                    <td>
                                        <c:url var="updateNilai" value="/updateNilai">
                                            <c:param name="id" value="${nilai.id}"/>
                                        </c:url>
                                        <a href="${updateNilai}">Edit</a>
                                        <c:url var="deleteNilai" value="/deleteNilai">
                                            <c:param name="id" value="${nilai.id}"/>
                                        </c:url>
                                        <a href="${deleteNilai}">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
